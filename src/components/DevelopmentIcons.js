...
function DevelopmentIcons({ reference }) {
  ...
  return (
    <figure className='absolute left-0 stroke-dark dark:stroke-light xs:hidden'>
      <svg className='-rotate-90 md:w-[60px] md:h-[60px]' width='75' height='75' viewBox='0 0 100 100'>
